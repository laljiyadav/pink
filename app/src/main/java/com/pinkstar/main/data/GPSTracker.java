...
import com.pinkstar.main.Mobile;
    ...
    public Location getLocation() {
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                //Toast.makeText(mContext,"both denied",Toast.LENGTH_SHORT).show();
                ...
                if (isNetworkEnabled) {
                    if (ContextCompat.checkSelfPermission(mContext, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(mContext, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        //Toast.makeText(mContext, "network denied", Toast.LENGTH_SHORT).show();
                    ...
                    if (isGPSEnabled) {
                        if (ContextCompat.checkSelfPermission(mContext, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(mContext, Manifest.permission.ACCESS_COARSE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                           ...
                           // Toast.makeText(mContext, "Gps denied", Toast.LENGTH_SHORT).show();
                        }
                        return location;
                    }
